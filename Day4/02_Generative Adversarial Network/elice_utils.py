...
if not all((EXECUTION_TOKEN, EXECUTOR_IP, EXECUTOR_COM_PORT)):
    ...
    print("Warning: This script is running on the non-elice environment. All outputs will be redirected to standard output.")
    print("=============================")
...
def _send(url, data):
    if _LOCAL_MODE:
        msg_type = data['type']
        msg_data = data['data']
        if msg_type == 'grader' or msg_type == 'score':
